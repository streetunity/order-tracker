...
# This checks for associated orders before allowing account deletion

echo "Applying safer delete patch to api/src/index.js..."

# Create a backup
cp api/src/index.js api/src/index.js.backup
...
cd api/src && node apply-patch.js
