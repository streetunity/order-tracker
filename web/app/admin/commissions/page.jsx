    ...
    <>
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "24px 24px 40px" }}>
        ...
        <BulkActionsBar
          ...
          onGenerateReport={generateReportFromSelected}
      ...
      <RejectPaymentModal
        ...
        onExecute={executeReject}
      />

      <UnflagModal
        show={showUnflagModal}
        onClose={() => setShowUnflagModal(false)}
        unflagNotes={unflagNotes}
        setUnflagNotes={setUnflagNotes}
        onExecute={executeUnflag}
      />

      <DeleteOrphanModal
        show={showDeleteOrphanModal}
        onClose={() => setShowDeleteOrphanModal(false)}
        onExecute={executeDeleteOrphan}
      />

      <RecalculateModal
        show={showRecalculateModal}
        onClose={() => setShowRecalculateModal(false)}
        onExecute={executeRecalculate}
      />

      <UnapproveModal
        show={showUnapproveModal}
        onClose={() => setShowUnapproveModal(false)}
        onExecute={executeUnapprove}
      />

      <UnpayModal
        show={showUnpayModal}
        onClose={() => setShowUnpayModal(false)}
        onExecute={executeUnpay}
      />
