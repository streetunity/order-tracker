...
export default function NewOrderPage() {
  ...
  const [customSalesPerson, setCustomSalesPerson] = useState(""); // Add state for custom input
  const [showCustomInput, setShowCustomInput] = useState(false); // Track if custom input should show
  const [formData, setFormData] = useState({
    accountId: "",
    poNumber: "", // Still poNumber in backend
    sku: "", // Still sku in backend - will store user name or custom value
  ...
  async function handleSubmit(e) {
    ...
    try {
      // If custom sales person is selected, use the custom value
      const submitData = {
        ...formData,
        sku: showCustomInput ? customSalesPerson : formData.sku
      };
  ...
  function handleSalesPersonChange(e) {
    ...
    if (value === "Other (custom)") {
      ...
      setFormData({ ...formData, sku: "Other (custom)" });
      setCustomSalesPerson(""); // Clear custom input
    } else {
    ...
    <main style={{ padding: "40px 20px", maxWidth: "800px", margin: "0 auto" }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          {/* If "Other (custom)" is selected, show text input - FIXED */}
          {showCustomInput && (
            <input
              type="text"
