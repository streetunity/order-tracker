      ...
      <div style={{ width: "80%", maxWidth: "1800px", margin: "0 auto", paddingTop: 80 }}>
        ...
        <div style={{ marginBottom: 24, display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 16 }}>
          <div>
            ...
            <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" }}>
              <span style={{
                ...
                border: `1px solid ${STATUS_COLORS[lead.status]?.border}`,
                borderRadius: "4px",
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {lead.status !== "CONVERTED" && (
              <>
                {!isEditing ? (
                  ...
                  <>
                    <button
                      onClick={() => { setIsEditing(false); loadLead(); }}
                      style={{
                        padding: "10px 20px",
                        background: "rgba(255, 255, 255, 0.05)",
                        border: "1px solid rgba(255, 255, 255, 0.1)",
            ...
            {lead.status === "CONVERTED" && lead.convertedToCustomer && (
              ...
              >
                View Customer: {lead.convertedToCustomer.customerNumber}
              </Link>
            )}
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 32 }}>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.firstName}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.lastName}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.email}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.phone || "-"}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.company || "-"}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.source}</div>
              )}
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 32 }}>
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.address || "-"}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.city || "-"}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.state || "-"}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.zipCode || "-"}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.country || "USA"}</div>
              )}
            </div>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 32 }}>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.timeline || "-"}</div>
              )}
            </div>
            <div>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.interestedIn || "-"}</div>
              )}
            </div>
            {formData.status === "LOST" && (
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                {isEditing ? (
                  ...
                  <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0" }}>{lead.lostReason || "-"}</div>
                )}
              </div>
            )}
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 32 }}>
            ...
            <div style={{ gridColumn: "1 / -1" }}>
              ...
              {isEditing ? (
                ...
                <div style={{ color: "rgba(255,255,255,0.9)", padding: "10px 0", whiteSpace: "pre-wrap" }}>
                  {lead.followUpNotes || "-"}
                </div>
              )}
            </div>
          ...
          <div style={{ marginTop: 32, paddingTop: 16, borderTop: "1px solid rgba(255,255,255,0.1)" }}>
            <div style={{ display: "flex", gap: 24, color: "rgba(255,255,255,0.5)", fontSize: "12px" }}>
              ...
              {lead.lastContactAt && (
                <span>Last Contact: {new Date(lead.lastContactAt).toLocaleString()}</span>
              )}
            </div>
          </div>
        </div>
        ...
        {showConvertConfirm && (
          ...
          >
            ...
            >
              <h3 style={{ fontSize: "18px", fontWeight: "600", color: "#fff", marginTop: 0, marginBottom: "1rem" }}>
                Convert Lead to Customer
              </h3>
              <p style={{ fontSize: "14px", marginBottom: "1rem", color: "#d1d5db" }}>
                Convert <strong>{lead.firstName} {lead.lastName}</strong> to a new customer?
              </p>
              <p style={{ fontSize: "13px", marginBottom: "1.5rem", color: "rgba(255,255,255,0.5)" }}>
