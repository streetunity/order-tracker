  ...
  return (
    <>
      ...
      <style>{`
        ...
        .cust-left { width: 280px; min-width: 280px; display: flex; flex-direction: column; background: linear-gradient(180deg,#1b1b1b 0%,#131313 46%,#101010 100%); border-right: 1px solid rgba(255,255,255,0.1); box-shadow: inset -1px 0 0 rgba(0,0,0,0.7), 18px 0 42px rgba(0,0,0,0.34); }
        ...
        .cust-item { padding: 12px 12px; cursor: pointer; border-left: 3px solid rgba(255,255,255,0.03); transition: background 0.14s, border-color 0.14s, box-shadow 0.14s, transform 0.14s; border-bottom: 0; border-radius: 9px; background: linear-gradient(180deg,rgba(255,255,255,0.055),rgba(255,255,255,0.024)); border-top: 1px solid rgba(255,255,255,0.075); border-right: 1px solid rgba(255,255,255,0.035); margin-bottom: 8px; box-shadow: 0 8px 18px rgba(0,0,0,0.16); }
        .cust-item:hover { background: linear-gradient(180deg,rgba(255,255,255,0.105),rgba(255,255,255,0.052)); border-left-color: rgba(255,75,75,0.86); box-shadow: 0 16px 34px rgba(0,0,0,0.34), inset 0 1px 0 rgba(255,255,255,0.08), 0 0 0 1px rgba(220,38,38,0.12); transform: translateY(-2px); }
        ...
        .cust-count { padding: 8px 14px; font-size: 11px; color: rgba(255,255,255,0.34); text-align: center; border-top: 1px solid rgba(255,255,255,0.08); flex-shrink: 0; background: linear-gradient(180deg,rgba(255,255,255,0.025),rgba(0,0,0,0.28)); }
        .cust-right { flex: 1; display: flex; align-items: center; justify-content: center; background: radial-gradient(circle at 12% 8%,rgba(220,38,38,0.095),transparent 360px),radial-gradient(circle at 70% 0%,rgba(255,255,255,0.035),transparent 420px),#0f0f0f; }
        .cust-empty { display: flex; flex-direction: column; align-items: center; text-align: center; gap: 10px; }
        .cust-sort-bar { display: flex; gap: 4px; padding: 8px; border-bottom: 1px solid rgba(255,255,255,0.08); flex-shrink: 0; background: linear-gradient(180deg,rgba(0,0,0,0.18),rgba(255,255,255,0.018)); }
        ...
        .cust-sort-btn.active { background: linear-gradient(180deg,rgba(220,38,38,0.18),rgba(220,38,38,0.09)); border-color: rgba(255,75,75,0.42); color: #ff4b4b; box-shadow: inset 0 1px 0 rgba(255,255,255,0.06); }
      `}</style>
