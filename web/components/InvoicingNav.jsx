        ...
        <div className="nav-container">
          <div className="nav-left">
            ...
            <div className="nav-links">
              ...
              <Link href="/admin/calendar" className={`nav-link ${isActive("/admin/calendar") ? "active" : ""}`} onClick={(e) => handleNavClick(e, "/admin/calendar")}>
                ...
                <div className="user-dropdown">
                  ...
                  {isAdmin && (
                    <>
                      ...
                      <Link href="/history" className="dropdown-item" onClick={(e) => handleNavClick(e, "/history")}>
