      ...
      <div className="nav-container">
        <div className="nav-left">
          ...
          <div className="nav-links">
            <Link href="/invoicing" className={`nav-link ${isActive("/invoicing") && pathname === "/invoicing" ? "active" : ""}`} onClick={(e) => handleNavClick(e, "/invoicing")}>
            ...
            <Link href="/invoicing/settings" className={`nav-link ${isActive("/invoicing/settings") ? "active" : ""}`} onClick={(e) => handleNavClick(e, "/invoicing/settings")}>
            ...
            {canSeeEmailTemplates && (
              <Link href="/admin/email" className={`nav-link ${isActive("/admin/email") ? "active" : ""}`} onClick={(e) => handleNavClick(e, "/admin/email")}>
                <svg className="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                Email Templates
              </Link>
            )}
          </div>
          ...
          <div className="user-menu" onClick={() => setDropdownOpen(!dropdownOpen)} ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="user-dropdown">
                ...
                <div className="dropdown-divider"></div>
                <Link href="/admin/profile" className="dropdown-item" onClick={(e) => handleNavClick(e, "/admin/profile")}>
                ...
                <Link href="/admin/change-password" className="dropdown-item" onClick={(e) => handleNavClick(e, "/admin/change-password")}>
